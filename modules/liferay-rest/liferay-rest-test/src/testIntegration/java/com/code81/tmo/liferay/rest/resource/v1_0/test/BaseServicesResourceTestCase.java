 ...
 */
@Generated("")
public abstract class BaseServicesResourceTestCase {
	...
	public void setUp() throws Exception {
		...
		_servicesResource.setContextCompany(testCompany);

		_testCompanyAdminUser = UserTestUtil.getAdminUser(
			testCompany.getCompanyId());

		servicesResource = ServicesResource.builder(
		).authentication(
	...
	public void testGetServices() throws Exception {
		...
		ServicesResponse postServicesResponse =
			testGetServices_addServicesResponse(
				postServices.getServicesId(), randomServicesResponse());

		ServicesResponse getServicesResponse = servicesResource.getServices(
			postServices.getServicesId());

		assertEquals(postServicesResponse, getServicesResponse);
		assertValid(getServicesResponse);
	}

	protected ServicesResponse testGetServices_addServicesResponse(
			long servicesId, ServicesResponse servicesResponse)
		throws Exception {
	...
	protected void assertContains(Object services, List<Object> serviceses) {
		...
		for (Object item : serviceses) {
			if (equals(services, item)) {
				contains = true;
		...
		Assert.assertTrue(
			serviceses + " does not contain " + services, contains);
	}
	...
	protected void assertEquals(Object services1, Object services2) {
		Assert.assertTrue(
			services1 + " does not equal " + services2,
			equals(services1, services2));
	}

	protected void assertEquals(
		List<Object> serviceses1, List<Object> serviceses2) {

		Assert.assertEquals(serviceses1.size(), serviceses2.size());

		for (int i = 0; i < serviceses1.size(); i++) {
			Object services1 = serviceses1.get(i);
			Object services2 = serviceses2.get(i);
	...
	protected void assertEquals(
		ServicesResponse servicesResponse1,
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (Object services1 : serviceses1) {
			boolean contains = false;

			for (Object services2 : serviceses2) {
				if (equals(services1, services2)) {
					contains = true;
			...
			Assert.assertTrue(
				serviceses2 + " does not contain " + services1, contains);
		}
	}

	protected void assertValid(Object services) throws Exception {
		boolean valid = true;
	...
	protected void assertValid(
		...
		java.util.Collection<Object> serviceses = page.getItems();

		int size = serviceses.size();
	...
	protected void assertValid(ServicesResponse servicesResponse) {
		boolean valid = true;

		for (String additionalAssertFieldName :
				getAdditionalServicesResponseAssertFieldNames()) {
	...
	protected boolean equals(Object services1, Object services2) {
	...
	protected boolean equals(
		...
		if (servicesResponse1 == servicesResponse2) {
			return true;
		}
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("page", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						servicesResponse1.getPage(),
						servicesResponse2.getPage())) {
			...
			if (Objects.equals("services", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						servicesResponse1.getServices(),
						servicesResponse2.getServices())) {
			...
			if (Objects.equals("size", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						servicesResponse1.getSize(),
						servicesResponse2.getSize())) {
			...
			if (Objects.equals("totalCount", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						servicesResponse1.getTotalCount(),
						servicesResponse2.getTotalCount())) {
			...
			if (Objects.equals("totalPages", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						servicesResponse1.getTotalPages(),
						servicesResponse2.getTotalPages())) {
	...
	protected java.util.Collection<EntityField> getEntityFields()
		...
		if (!(_servicesResource instanceof EntityModelResource)) {
			throw new UnsupportedOperationException(
				"Resource is not an instance of EntityModelResource");
		}

		EntityModelResource entityModelResource =
			(EntityModelResource)_servicesResource;
	...
	protected String getFilterString(
		EntityField entityField, String operator, Object services) {
	...
	protected ServicesResponse randomServicesResponse() throws Exception {
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseServicesResourceTestCase.class);
	...
	@Inject
	private com.code81.tmo.liferay.rest.resource.v1_0.ServicesResource
		_servicesResource;
