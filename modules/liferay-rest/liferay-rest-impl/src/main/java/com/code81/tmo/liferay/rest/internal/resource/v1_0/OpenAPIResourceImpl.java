...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "LiferayRest REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "LiferayRest", version = "v1.0")
)
@Path("/v1.0")
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			...
			add(NewsResourceImpl.class);

			add(ServicesResourceImpl.class);
