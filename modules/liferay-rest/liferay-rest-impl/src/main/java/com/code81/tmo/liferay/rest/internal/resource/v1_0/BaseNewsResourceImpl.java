...
public abstract class BaseNewsResourceImpl implements NewsResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/liferay-rest/v1.0/news'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(description = "Retrieve News")
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "News")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/news")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseNewsResourceImpl.class);
