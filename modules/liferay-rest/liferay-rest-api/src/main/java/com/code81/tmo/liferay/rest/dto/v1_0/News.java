...
public class News implements Serializable {
	...
	public static News toDTO(String json) {
		return ObjectMapperUtil.readValue(News.class, json);
	}

	public static News unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(News.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.code81.tmo.liferay.rest.dto.v1_0.News",
		name = "x-class-name"
	)
