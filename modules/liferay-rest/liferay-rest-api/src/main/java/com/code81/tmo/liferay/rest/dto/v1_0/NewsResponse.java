 ...
 */
@Generated("")
@GraphQLName("NewsResponse")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "NewsResponse")
public class NewsResponse implements Serializable {

	public static NewsResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(NewsResponse.class, json);
	}

	public static NewsResponse unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(NewsResponse.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema
	@Valid
	public News[] getNewses() {
		if (_newsesSupplier != null) {
			newses = _newsesSupplier.get();

			_newsesSupplier = null;
		}
	...
	public void setNewses(
		...
		_newsesSupplier = () -> {
			try {
				return newsesUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<News[]> _newsesSupplier;
	...
	public String toString() {
		...
		if (newses != null) {
			...
			for (int i = 0; i < newses.length; i++) {
				sb.append(String.valueOf(newses[i]));

				if ((i + 1) < newses.length) {
					sb.append(", ");
				}
			}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.code81.tmo.liferay.rest.dto.v1_0.NewsResponse",
		name = "x-class-name"
	)
