...
public class EventsResponse implements Serializable {
	...
	public static EventsResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(EventsResponse.class, json);
	}

	public static EventsResponse unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(EventsResponse.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.code81.tmo.liferay.rest.dto.v1_0.EventsResponse",
		name = "x-class-name"
	)
